	...
	tests := []struct {
		...
		0: {
			...
			definition: model.ServerDefinition{
				...
				Tags: []model.DefinitionTag{
					{Description: "Blueprint Wipe", Icon: model.IconKindCalendarDay, Value: "Monthly"},
				},
				Events: []model.DefinitionEvent{
					{Weekday: 1, Hour: 18, EventKind: model.EventKindStart},
					{Weekday: 2, Hour: 21, EventKind: model.EventKindStop},
					{Weekday: 2, Hour: 18, EventKind: model.EventKindStart},
					{Weekday: 3, Hour: 21, EventKind: model.EventKindStop},
					{Weekday: 3, Hour: 18, EventKind: model.EventKindStart},
					{Weekday: 4, Hour: 21, EventKind: model.EventKindStop},
					{Weekday: 4, Hour: 18, EventKind: model.EventKindStart},
					{Weekday: 5, Hour: 21, EventKind: model.EventKindStop},
					{Weekday: 5, Hour: 18, EventKind: model.EventKindStart},
					{Weekday: 6, Hour: 21, EventKind: model.EventKindStop},
					{Weekday: 6, Hour: 18, EventKind: model.EventKindStart},
					{Weekday: 7, Hour: 21, EventKind: model.EventKindStop},
					{Weekday: 7, Hour: 18, EventKind: model.EventKindStart},
					{Weekday: 1, Hour: 21, EventKind: model.EventKindStop},
				},
		...
		1: {
			...
			definition: model.ServerDefinition{
				...
				Background:             model.BackgroundKindJunkyard,
